...
class Sendemail extends CI_Model {
    ...
    public function addEvent($name, $toemail, $fromemail, $fromname, $subjectemail, $wa, $harga){

        $content = 'Terima Kasih sudah ikut serta ke event Kami !'; 
        $content2 = 'diMohon Untuk Lakukan Pembayaran Sebesar <br><center><h1><b> Rp. '.$harga.',- / rider </b></h1></center><br> dan lakukan konfirmasi Pembayaran 
        di nomor ini '.$wa.' melalui <a href="#" target="_blank">Whatsapp</a> Terima Kasih!'; 
        $button = ''; 
    ...
    public function register($name, $toemail, $fromemail, $fromname, $subjectemail){
        ...
        $content = 'Terima Kasih sudah mendaftar di Never Say Old kami!'; 
        $content2 = ''; 
        $button = ''; 
