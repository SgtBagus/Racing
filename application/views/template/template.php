...
<body class="hold-transition skin-blue layout-top-nav">
  <div class="wrapper">
        ...
        <div class="container">
          <div class="navbar-header">
            <div class="header-center">
              <button type="button" id="sidebarButton" class="navbar-toggle collapsed button-collapse open-sidebar" data-toggle="control-sidebar">
    ...
    <div class="content-wrapper">
      <aside id="sidebar" class="control-sidebar control-sidebar-dark" style="display: none;">
