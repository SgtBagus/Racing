                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-7">
                                                ...
                                                if ($row['approve'] == 'WAITING') {
                                                    echo '<small class="label pull-right bg-yellow"><i class="fa fa-warning"> </i> Menunggu Dikonfirmasi </small>';
                                                } else if($row['approve'] == "APPROVE") {
                                                    echo '<small class="label pull-right bg-green"><i class="fa fa-check"> </i> Pendaftaran Di Terima </small>';
                                                } else if($row['approve'] == "REJECT") {
                                                    echo '<small class="label pull-right bg-red"><i class="fa fa-ban"> </i> Pendaftaran Di Tolak </small>'; 
                                                }else if($row['approve'] == "FINISH") {
                                                    echo '<small class="label pull-right bg-green"><i class="fa fa-check"> </i> Event Selesai </small>';
                                                }else if($row['approve'] == "CANCEL") {
                                                    echo '<small class="label pull-right bg-red"><i class="fa fa-ban"> </i> Event Dibatalkan</small>';
                                                }?>
                                                <br>
