...
(function(root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="row daterangepicker dropdown-menu" style="witdh:100%"> <div align="center"><b>Tanggal Awal</b></div>' +
            ...
            '</div>' +
            '<div class="calendar right"><div align="center"><b>Tanggal Akhir</b></div>' +
            '<div class="daterangepicker_input">' +
